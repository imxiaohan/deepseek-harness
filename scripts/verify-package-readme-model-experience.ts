...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/desktop-app': { kind: 'indirect', reason: 'The patch layer recomposes the same roster the Web bundle composes; each composed row owns its model-facing behavior.' },
