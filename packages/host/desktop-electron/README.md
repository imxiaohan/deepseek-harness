...
| [`src/native-host-client.ts`](src/native-host-client.ts) | The host-child native-op client: correlated `pick-directory` round trips to Electron main |
